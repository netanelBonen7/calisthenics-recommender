...
class SQLiteEmbeddedExerciseSearchRepository:
    def __init__(self, cache_path: Path | str, batch_size: int = 100) -> None:
        self._embedded_exercise_repository = SQLiteEmbeddedExerciseRepository(
            cache_path,
