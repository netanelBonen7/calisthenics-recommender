...
def test_embedded_exercise_repository_is_a_runtime_checkable_protocol():
    ...
    assert get_type_hints(EmbeddedExerciseRepository.iter_embedded_exercises)[
        "return"
    ] == Iterable[EmbeddedExercise]
...
def test_embedded_exercise_repository_can_be_implemented_by_a_simple_fake_class():
    ...
    assert list(repository.iter_embedded_exercises()) == [embedded_exercise]
